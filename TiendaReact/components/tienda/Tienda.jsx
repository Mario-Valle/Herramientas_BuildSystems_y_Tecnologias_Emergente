...
class Tienda extends React.Component{
  ...
  mostrarProductos(){
    return this.state.productos.map(
      (producto) => { return <Catalogo actualizarDisponible={this.actualizarDisponible} productos={this.state.productos} key={ producto.id } disponible={ producto.disponible } id={producto.id} imagen={ producto.imagen } informacion={ producto.informacion } nombre={ producto.nombre } precio ={producto.precio} /> }
    )
  }
  //----------------------------------------------------------------------------
